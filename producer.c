...
size_t get_input_file_size(struct msg_data* data, char* request, char* file_name){
    ...
    //sprintf(data->message, file_name); // message will be the file's name
...
int main(int argc, char *argv[]){
    ...
    //
    char* input_file_name = "input.txt"; // temporary
    FILE* input_file;   
    ...
    */
    ...
    /* TODO: no need to loop thru all, calculate how many buffers are needed by scanning input file size */
    int totalBytes = 0;
